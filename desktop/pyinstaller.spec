# PyInstaller spec for the standalone Centinelas desktop build.
...
if sys.platform == "darwin":
    app = BUNDLE(
        coll,
        name=f"{APP_NAME}.app",
        icon=str(REPO_ROOT / "PRII-CENTINELAS.app" / "Contents" / "Resources" / "AppIcon.icns"),
