...
- Preferred: open a private [GitHub Security Advisory](https://github.com/jotaele44/centinelas-pr/security/advisories/new)
  for this repository.
...
This policy covers the `centinelas-pr` source code and its CI/CD configuration.
