  ...
  return (
    <div className="bg-card rounded-2xl border border-border p-6">
      <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
        ...
        Línea de tiempo del proceso legislativo
      </h2>
        ...
        {STAGES.map((stage, i) => {
          ...
          return (
            <div key={stage.key} className="flex gap-4 pb-6 last:pb-0 relative">
              ...
              >
                {isPassed ? <Check className="w-4 h-4" /> : <Circle className="w-3 h-3" />}
              </div>
              <div className="pt-1">
        ...
        {isRejected && (
          <div className="flex gap-4 relative">
            ...
            <div className="pt-1">
              ...
              <p className="text-sm text-muted-foreground">El proyecto no fue aprobado</p>
              {law.last_action_date && (
