...
export const EN = {
  ...
  // SignalsTable / Entities / EntityDetail (converted signal-centric pages)
  "Señales — vista de tabla": "Signals — table view",
  "Todas las señales pre-oficiales en una sola pantalla. Cada fila enlaza a su asunto.": "All pre-official signals on a single screen. Each row links to its matter.",
  "Ver como tarjetas": "View as cards",
  ...
  "Tipo": "Type",
  "Entidades": "Entities",
  "Agencias, personas y organizaciones mencionadas en las señales y asuntos monitoreados.": "Agencies, people and organizations mentioned in the monitored signals and matters.",
  "Buscar entidad": "Search entity",
  "agencia, persona, organización…": "agency, person, organization…",
  "menciones": "mentions",
  "señales": "signals",
  "Agencia": "Agency",
  "Persona": "Person",
  ...
  "Entidad": "Entity",
  "Cargando entidad…": "Loading entity…",
  "No se pudo cargar la entidad. Revisa la conexión con el almacén de datos e inténtalo de nuevo.": "Could not load the entity. Check the connection to the data store and try again.",
  "Entidad no encontrada.": "Entity not found.",
  "Volver a entidades": "Back to entities",
